...
import cn.jedisoft.framework.app.BaseContextLoader;
...
import cn.jedisoft.framework.core.conf.ApiDefinition;
...
public class WebAppContextLoader extends BaseContextLoader<WebAppContext> {
	...
	public WebAppContext load(AppContextConf conf) {
		...
		context.setAutowireUsing(conf.getJediAutowire().getUsing());
