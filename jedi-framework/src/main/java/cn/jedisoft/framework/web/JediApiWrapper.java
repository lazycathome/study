...
import cn.jedisoft.framework.web.annotations.method.DELETE;
import cn.jedisoft.framework.web.annotations.method.GET;
import cn.jedisoft.framework.web.annotations.method.POST;
import cn.jedisoft.framework.web.annotations.method.PUT;
import cn.jedisoft.framework.web.common.UriPattern;
...
import cn.jedisoft.framework.web.result.WebResultProcessor;
 ...
 *
 */
public class JediApiWrapper implements WebApiWrapper {
	...
	public boolean process(String url, String method, HttpServletRequest request, HttpServletResponse response, AutowireBeanFactory factory) {
		...
		if(w != null) {
			...
			if(result != null) {
				WebResultProcessor.render(result, request, response);
